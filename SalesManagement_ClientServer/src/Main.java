...
public class Main 
{
	...
	public static void management()
	{
		...
		try
		{
			while(!terminate)
			{
				System.out.println(loggedUser.getFunctionalities());
				...
				if(enMode == 0)
					...
					loggedUser.doFunctionality(enMode);
			}
		}
	...
	public static void doLogin()
	{
		...
		try
		{
			while(!success)
			{
				...
				{
					success = true;
					System.out.println("Login successfully! Welcome " + loggedUser.getName());
				}
	...
	public static void main(String[] args) 
	{
		...
		Client client1 = new Client("Cli1", "123", "Cliente", "Uno", "123pipposur", "Mountain street 11");
		...
		Client client2 = new Client("Cli2", "456", "Cliente", "Due", "456plutosur", "Sea street 11");
