...
public class Employee extends User 
{
	...
	protected Client getSelectedClient(String taxCode)
	{
		...
		{
			for (User currentUser : Main.userList) //Select client
			{
				if(currentUser instanceof Client) // Add check for object types
				{
					Client selectClient = (Client) currentUser;
					if(taxCode.equals(selectClient.getTaxCode())) //Get selected client
						return selectClient;
				}
	...
	protected void showClientsList()
	{
		for (User currentUser : Main.userList) //Select client
		{
			...
			{
				Client selectClient = (Client) currentUser;
				System.out.print(selectClient.toString());
				selectClient.printPurchases();
			}
		}
	}
